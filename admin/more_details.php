							...
							<tbody>
								...
								<?php
										if ($row['admin_status'] == 0) {
											echo "<td>
											<a href='confirmed.php?id=" . $row['property_id'] . "&username=".$username."' class='btn btn-danger btn-sm' data-toggle='modal'><i class='fa-solid fa-plug-circle-exclamation'></i>waiting for Confirm</a>
									</td>
								</tr>";
										} else {
											echo "<td>
									<a href='unconfirm.php?id=" . $row['property_id'] . "&username=".$username."' class='btn btn-success btn-sm' data-toggle='modal'><i class='fa-solid fa-square-check'></i> Confirmed</a>
							</td>
						</tr>";
										}
									}
