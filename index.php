      ...
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          ...
          <div class="text-content">
            ...
            <a href="residential.php" target="blank"><button class="read-btn">Read More <i class="uil uil-arrow-right"></i></button></a>
          </div>
        </div>
...
<a href="real.php" target="blank"><button class="read-btn">Read More <i class="uil uil-arrow-right"></i></button></a>
        ...
        <div class="swiper-slide dark-layer">
          ...
          <div class="text-content">
            ...
            <a href="land.php" target="blank"><button class="read-btn">Read More <i class="uil uil-arrow-right"></i></button></a>
          </div>
        </div>
  ...
  <div class="search2 container">
      ...
      <button class="button_search" name="search2">Search</button>
      </form>
    </div>
...
<div class="cl" style="display: flex; margin: 10px;">
        ...
        <a href="view.php?id=<?php echo $q['id'] ?>" class="btn btn-light"> <button class="btn_read" style="margin: 25px; height: 50px; width: 150px;"> Read More <span class="text-danger">&rarr;</span></button></a>
      ...
      <?php $counter++;} }
       ...
       <a href="property.php" class="btn btn-light" style="margin-left: 40%"> <button class="btn_read" style="margin: 25px; height: 50px; width: 400px; background-color: gray; left: 50%"> Load More <span class="text-danger">&rarr;</span></button></a>
