...
FROM property
INNER JOIN gallary_image INNER JOIN property_basic_feature ON property.property_id=gallary_image.id AND property.property_id=property_basic_feature.id WHERE property_status = "sell" AND sub_proper = "office_space" AND property_type = "commercial"';
